...
pub trait VariableResolver: Send {
    fn resolve(&self, var_type: &str, params: &Option<serde_norway::Value>) -> anyhow::Result<String>;
}
...
impl VariableResolver for ClipboardVariable {
    fn resolve(&self, var_type: &str, _params: &Option<serde_norway::Value>) -> anyhow::Result<String> {
...
impl VariableEngine {
    ...
    pub fn resolve_all(
        &self,
        vars: &[texpand_config::VariableDef],
...
mod tests {
    ...
    fn test_variable_engine_resolve_all() {
        use texpand_config::VariableDef;
