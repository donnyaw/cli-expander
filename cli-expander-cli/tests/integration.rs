...
"#;
    ...
    let config = yaml.parse::<cli_expander_config::Config>().unwrap();
...
fn test_match_engine_with_real_config() {
    use cli_expander_config::MatchFile;
    use cli_expander_match::Matcher;
...
fn test_template_with_variable_engine() {
    use cli_expander_render::Template;
    use cli_expander_render::VariableEngine;
...
fn test_form_extension_integration() {
    ...
    use cli_expander_render::FormExtension;
...
fn test_config_from_file_simulation() {
    use cli_expander_config::Config;
...
fn test_detect_evdev_key_source_creation() {
    use cli_expander_detect::{EvdevKeySource, KeySource};
